...
public class Main {
    ...
    private  void remove() {
        ...
        do {
            String vin = readVin();
            Car car = carStorage.delete(vin);
            if (car != null) {
                System.out.println("Автомобиль успешно удален: vin = " + car.getVin());
                break;
            }
    ...
    private void findCars() {
        ...
        switch (findType) {
            ...
            case 2: {
                Car car = carStorage.getByVin(readVin());
                carSet = car != null ? Collections.singleton(car) : Collections.emptySet();
                break;
            }
